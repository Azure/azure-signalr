...
internal class TestHub(TestHubConnectionManager testHubConnectionManager) : Hub
{
    private TestHubConnectionManager _testHubConnectionManager = testHubConnectionManager;
