...
public class VerifiableLoggedTest(ITestOutputHelper output) : LoggedTest(output)
{
    ...
    public virtual ILogProvider StartVerifiableLog(out ILoggerFactory loggerFactory, [CallerMemberName] string testName = null, Func<WriteContext, bool> expectedErrors = null)
    {
    ...
    public virtual ILogProvider StartVerifiableLog(out ILoggerFactory loggerFactory,
