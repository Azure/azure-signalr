...
public class AuthUtilityTests
{
    ...
    public void TestAccessTokenTooLongThrowsException()
    {
        ...
        var accessKey = new LocalAccessKey(new Uri("http://localhost:443"), SigningKey);
    ...
    public class CachingTestData : IEnumerable<object[]>
    {
        ...
        {
            yield return new object[] { new LocalAccessKey(new Uri("http://localhost:443"), SigningKey), true };
