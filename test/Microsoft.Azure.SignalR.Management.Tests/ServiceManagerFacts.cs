...
namespace Microsoft.Azure.SignalR.Management.Tests
{
    public class ServiceManagerFacts
    {
        ...
        {
            var manager = new ServiceManager(new ServiceManagerOptions() { ConnectionString = _testConnectionString, ApplicationName = appName }, new RestClientFactory(UserAgent));
        ...
        internal async Task CreateServiceHubContextTest(ServiceTransportType serviceTransportType, bool useLoggerFacory, string appName, int connectionCount)
        {
            ...
            }, new RestClientFactory(UserAgent));
        ...
        internal async Task IsServiceHealthy_ReturnTrue_Test()
        {
            ...
            var serviceManager = new ServiceManager(new ServiceManagerOptions() { ConnectionString = _testConnectionString, ProductInfo = UserAgent }, factory);
        ...
        internal async Task IsServiceHealthy_ReturnFalse_Test(HttpStatusCode statusCode)
        {
            ...
            var serviceManager = new ServiceManager(new ServiceManagerOptions() { ConnectionString = _testConnectionString }, factory);
            var actual = await serviceManager.IsServiceHealthy(default);
