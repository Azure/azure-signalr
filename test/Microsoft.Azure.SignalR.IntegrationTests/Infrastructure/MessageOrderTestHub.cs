...
namespace Microsoft.Azure.SignalR.IntegrationTests.Infrastructure
{
    ...
    //
    // Use separate hubs to prevent concurrently running tests to interfere with each other
    //
    public class MessageOrderTestHub2 : Hub
    {
        public async Task<bool> BroadcastNumCalls(int numCalls)
        {
            for (int i = 0; i < numCalls;)
    ...
    public class MessageOrderTestHub3 : Hub
    {
    ...
    public class MessageOrderTestHub4 : Hub
    {
