            ...
            switch (e)
            {
                case HttpOperationException operationException:
                    ...
                    return response.StatusCode switch
                    {
                        ...
                        HttpStatusCode.Unauthorized => AzureSignalRUnauthorizedException.Wraps(authType, request.RequestUri, innerException),
        ...
        internal static Exception WrapAsAzureSignalRException(this Exception e, AuthType authType)
        {
            switch (e)
            {
                case WebSocketException webSocketException:
                    ...
                    {
                        return AzureSignalRUnauthorizedException.Wraps(authType, webSocketException);
                    }
                    return e;
                default: return e;
            }
