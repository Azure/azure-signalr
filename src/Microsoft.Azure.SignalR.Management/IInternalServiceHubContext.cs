...
namespace Microsoft.Azure.SignalR.Management
{
    internal interface IInternalServiceHubContext : IServiceHubContext
    {
        ...
        Task<NegotiationResponse> NegotiateAsync(HttpContext httpContext = null, string userId = null, IList<Claim> claims = null, TimeSpan? lifetime = null, CancellationToken cancellationToken = default);
