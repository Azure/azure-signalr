...
namespace Microsoft.Azure.SignalR.Management
{
    internal class ServiceContext : IServiceContext
    {
        ...
        public Task<ClientEndpoint> GetClientEndpointAsync(string hubName, HttpContext httpContext = null, string userId = null, IList<Claim> claims = null, TimeSpan? lifeTime = null)
        {
