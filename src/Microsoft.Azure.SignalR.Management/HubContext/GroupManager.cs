...
namespace Microsoft.Azure.SignalR.Management
{
    ...
    public abstract class GroupManager : IGroupManager
    {
        ...
        public virtual AsyncPageable<SignalRGroupConnection> ListConnectionsInGroup(string groupName, int? top = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
    }
}
