...
internal class CascadeServiceOptionsSetup(IOptionsMonitor<ServiceManagerOptions> sourceMonitor) : CascadeOptionsSetup<ServiceOptions, ServiceManagerOptions>(sourceMonitor)
{
