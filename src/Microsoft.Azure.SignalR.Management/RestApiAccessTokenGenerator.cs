...
namespace Microsoft.Azure.SignalR.Management
{
    internal class RestApiAccessTokenGenerator
    {
        ...
        {
            return AuthenticationHelper.GenerateAccessToken(_accessKey, audience, _claims, lifetime ?? Constants.Periods.DefaultAccessTokenLifetime, AccessTokenAlgorithm.HS256);
        }
