...
internal class NegotiateMiddleware : OwinMiddleware
{
    ...
    private Task ProcessNegotiationRequest(IOwinContext owinContext, HostContext context)
    {
        ...
        // add OriginalPath and QueryString when the clients protocol is above 2.0, earlier ASP.NET SignalR clients do not support redirect URL with query parameters
