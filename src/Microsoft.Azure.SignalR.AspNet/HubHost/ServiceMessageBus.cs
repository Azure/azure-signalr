        ...
        private async Task WriteMessage(IServiceConnectionContainer connection, AppMessage appMessage)
        {
            ...
            switch (message)
            {
                ...
                case ConnectionDataMessage connectionDataMessage:
                    if (_clientConnectionManager.ClientConnections.TryGetValue(connectionDataMessage.ConnectionId, out var context))
                    {
                        ...
                        await context.ServiceConnection.WriteAsync(message);
                    }
                    else
                    {
