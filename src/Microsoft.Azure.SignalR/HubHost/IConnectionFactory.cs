...
namespace Microsoft.Azure.SignalR
{
    ...
    {
        Task<ConnectionContext> ConnectAsync(TransferFormat transferFormat, string connectionId, IServiceEndpointProvider provider, CancellationToken cancellationToken = default);
