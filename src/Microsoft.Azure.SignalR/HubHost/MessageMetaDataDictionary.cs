...
namespace Microsoft.Azure.SignalR
{
    public class MessageMetaDataDictionary : Dictionary<string, string>
    {
        ...
        {
            return AddMetadata(HubInvocationMessageWrapper.ActionKeyName, actionName);
        }

        public MessageMetaDataDictionary AddClaims(IEnumerable<Claim> claims)
        {
            return AddMetadata(HubInvocationMessageWrapper.ClaimsKeyName,
        ...
        {
            return AddMetadata(HubInvocationMessageWrapper.ConnectionIdKeyName, connectionId);
        }

        public MessageMetaDataDictionary AddConnectionIds(IReadOnlyList<string> connectionIds)
        {
            return AddMetadata(HubInvocationMessageWrapper.ConnectionIdsKeyName, string.Join(",", connectionIds));
        }

        public MessageMetaDataDictionary AddExcludedIds(IReadOnlyList<string> excludedIds)
        {
            return AddMetadata(HubInvocationMessageWrapper.ExcludedIdsKeyName, string.Join(",", excludedIds));
        }

        public MessageMetaDataDictionary AddGroupName(string groupName)
        {
            return AddMetadata(HubInvocationMessageWrapper.GroupNameKeyName, groupName);
        }

        public MessageMetaDataDictionary AddGroupsName(IReadOnlyList<string> groupsName)
        {
            return AddMetadata(HubInvocationMessageWrapper.GroupNamesKeyName, string.Join(",", groupsName));
        }
        ...
        public MessageMetaDataDictionary AddMetadata(string key, string value)
        {
            Add(key, value);
            return this;
        }
        ...
        {
            return AddMetadata(HubInvocationMessageWrapper.UserKeyName, userId);
        }

        public MessageMetaDataDictionary AddUserIds(IReadOnlyList<string> userIds)
        {
            return AddMetadata(HubInvocationMessageWrapper.UsersKeyName, string.Join(",", userIds));
        }
