...
namespace Microsoft.Azure.SignalR
{
    internal class NegotiateHandler<THub> where THub : Hub
    {
            ...
            ILogger<NegotiateHandler<THub>> logger)
        {
            ...
            _customHandshakeTimeout = HandshakeTimeoutHelper.GetCustomHandshakeTimeout(hubOptions.Value.HandshakeTimeout ?? globalHubOptions.Value.HandshakeTimeout, _logger);
