...
namespace Microsoft.Azure.SignalR
{
    ...
    internal static class TypedClientBuilder<T>
    {
        ...
        private static Lazy<Func<Microsoft.AspNetCore.SignalR.IClientProxy, T>> _builder =
            new Lazy<Func<Microsoft.AspNetCore.SignalR.IClientProxy, T>>(() => GenerateClientBuilder());

        public static T Build(Microsoft.AspNetCore.SignalR.IClientProxy proxy)
        {
        ...
        private static Func<Microsoft.AspNetCore.SignalR.IClientProxy, T> GenerateClientBuilder()
        {
        ...
        private static Type GenerateInterfaceImplementation(ModuleBuilder moduleBuilder)
        {
            ...
            var proxyField = type.DefineField("_proxy", typeof(Microsoft.AspNetCore.SignalR.IClientProxy), FieldAttributes.Private);
        ...
        private static void BuildConstructor(TypeBuilder type, FieldInfo proxyField)
        {
            ...
            method.SetParameters(typeof(Microsoft.AspNetCore.SignalR.IClientProxy));
        ...
        private static void BuildMethod(TypeBuilder type, MethodInfo interfaceMethodInfo, FieldInfo proxyField)
        {
            ...
            var invokeMethod = typeof(Microsoft.AspNetCore.SignalR.IClientProxy).GetMethod(
