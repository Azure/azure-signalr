...
namespace Microsoft.Azure.SignalR
{
    ...
    // RoutedInvocation stores information of a client invocation which is routed by this server. This server is NOT the original caller of the client invocation
