...
**The ASRS instance cannot find another server connection to the same server**

![image](./client-connection-migration/scenario_c.png)

For more details, see [Server Connection Migration](./ServerConnectionMigration.md).
